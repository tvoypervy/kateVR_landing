...
document.addEventListener("DOMContentLoaded", ()=>{
    (0, _scrollUpJs.scrollUp)();
    (0, _playVideoJs.playVideo)();
    (0, _changeLangJs.changeLang)();
    (0, _openQuestionJs.openQuestion)();
    (0, _openDetailsJs.openDetails)();
...
},{"./components/scrollUp.js":"7Rlds","./components/playVideo.js":"ewPV2","./components/changeLang.js":"j0KMn","./components/openDetails.js":"amLhY","./components/formValidation.js":"2Qh99","./components/openQuestion.js":"2E19d","./components/swiper.js":"2Ir1S","./components/toggleList.js":"4XG2g","./components/chooseSelect.js":"iNd9w","./components/closeOrder.js":"5Dljr"}],"7Rlds":[function(require,module,exports) {
...
function scrollUp() {
    ...
    window.addEventListener("scroll", ()=>{
        if (window.scrollY > 100) scrollUpButton.classList.add("scroll-up--active");
        else scrollUpButton.classList.remove("scroll-up--active");
    });
}
...
},{}],"ewPV2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"j0KMn":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
    ...
    allNodes.forEach((node)=>{
        node.addEventListener("click", (e)=>{
            ...
            allNodes.forEach((item)=>{
                ...
                if (link) link.classList.toggle("language__link--active", isActive);
            });
        });
    });
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"amLhY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "openDetails", ()=>openDetails);
...
function findSelectedDetails(circle) {
    if (circle === firstCircle) return firstDetails;
    if (circle === secondCircle) return secondDetails;
    if (circle === thirdCircle) return thirdDetails;
}
...
var _chooseSelect = require("./chooseSelect");
function formValidation() {
    ...
    function inputValidation(input) {
        ...
        if (input.name === "phone") {
            ...
            for (const char of input.value)if (!phoneSymbols.includes(char)) {
                errorAction(input, label);
                label.textContent = `Incorrect format of ${input.name}*`;
                break;
            }
        ...
        if (input.name === "cardNumber") {
            ...
            for (const char of input.value)if (!cardSymbols.includes(char)) {
                errorAction(input, label);
        ...
        if (input.name === "expirationDate") {
            ...
            for (const char of input.value)if (!expirationDateSymbols.includes(char)) {
                errorAction(input, label);
                label.textContent = `Incorrect format of ${normalizeName(input.name)}*`;
                break;
            }
        ...
        if (input.name === "cvv") {
            ...
            for (const char of input.value)if (!cvvSymbols.includes(char)) {
                errorAction(input, label);
                label.textContent = `Incorrect format of ${input.name}*`;
                break;
            }
    ...
    function onSubmitPayForm(eventSubmit) {
        ...
        (0, _chooseSelect.chooseSelectHandler)(countItem, "count", countSelect, countList);
...
function normalizeName(inputId) {
    let normalizedName = "";
    for (const char of inputId)if (char === char.toUpperCase()) normalizedName += " " + char.toLowerCase();
    else normalizedName += char;
    return normalizedName;
}

},{"./chooseSelect":"iNd9w","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iNd9w":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "closeDropdown", ()=>closeDropdown);
parcelHelpers.export(exports, "chooseSelect", ()=>chooseSelect);
parcelHelpers.export(exports, "chooseSelectHandler", ()=>chooseSelectHandler);
...
function closeDropdown() {
    order.addEventListener("click", (e)=>{
        if (e.target !== countSelect) countList.classList.remove("count__list--active");
        if (e.target !== countriesSelect) countriesList.classList.remove("countries__list--active");
        if (e.target !== citiesSelect) citiesList.classList.remove("cities__list--active");
    });
}
function chooseSelect() {
    countItems.forEach((countItem)=>countItem.addEventListener("click", ()=>{
            chooseSelectHandler(countItem, "count", countSelect, countList);
            amount.textContent = `${+countItem.textContent * 1200}$`;
        }));
    countriesItems.forEach((countriesItem)=>countriesItem.addEventListener("click", ()=>{
            chooseSelectHandler(countriesItem, "countries", countriesSelect, countriesList);
        }));
    citiesItems.forEach((citiesItem)=>citiesItem.addEventListener("click", ()=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2E19d":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "openQuestion", ()=>openQuestion);
...
function openQuestion() {
    questions.forEach((question)=>{
        question.addEventListener("click", ()=>{
            ...
            if (wrapper.classList.contains("faq__info--active")) wrapper.classList.remove("faq__info--active");
            else {
                closeActiveQuestion();
...
parcelHelpers.export(exports, "sliderFraction", ()=>sliderFraction);
var _swiper = require("swiper");
var _swiperDefault = parcelHelpers.interopDefault(_swiper);
var _modules = require("swiper/modules");
// Вказуємо прямі шляхи до CSS файлів
var _swiperMinCss = require("swiper/swiper.min.css");
var _navigationCss = require("swiper/modules/navigation.css");
var _paginationCss = require("swiper/modules/pagination.css");
const headerSlider = new (0, _swiperDefault.default)(".header__slider", {
    modules: [
...
const slider = new (0, _swiperDefault.default)(".slider", {
    modules: [
        (0, _modules.Navigation),
        (0, _modules.Pagination),
        (0, _modules.Scrollbar),
        (0, _modules.Controller)
    ],
    autoHeight: true,
    grabCursor: true,
    pagination: {
...
const sliderFraction = new (0, _swiperDefault.default)(".slider", {
    modules: [
        (0, _modules.Pagination)
    ],
    pagination: {
...
},{"swiper":"iM6UL","swiper/modules":"9ktz6","swiper/swiper.min.css":"eFTGe","swiper/modules/navigation.css":"ae55e","swiper/modules/pagination.css":"lT27W","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iM6UL":[function(require,module,exports) {
/**
 * Swiper 12.1.2
...
function updateSlides() {
    ...
    // set cssMode offsets
    if (params.cssMode) {
        (0, _utilsMjs.b)(wrapperEl, "--swiper-slides-offset-before", `${offsetBefore}px`);
        (0, _utilsMjs.b)(wrapperEl, "--swiper-slides-offset-after", `${offsetAfter}px`);
    }
    ...
    if (!params.centeredSlides) {
        ...
        for(let i = 0; i < snapGrid.length; i += 1){
            ...
            if (shouldSnapToSlideEdge) // When snapToSlideEdge is enabled, only keep snaps up to lastAllowedSnapIndex
            {
                if (i <= lastAllowedSnapIndex) newSlidesGrid.push(slidesGridItem);
            } else if (snapGrid[i] <= swiper.virtualSize - swiperSize) // When snapToSlideEdge is disabled, keep snaps that fit within scrollable area
            newSlidesGrid.push(slidesGridItem);
        }
        snapGrid = newSlidesGrid;
        if (Math.floor(swiper.virtualSize - swiperSize) - Math.floor(snapGrid[snapGrid.length - 1]) > 1) // Only add edge-aligned snap if snapToSlideEdge is not enabled
        {
...
function Virtual({ swiper, extendParams, on, emit }) {
    ...
    on("init update resize", ()=>{
        if (!swiper.params.virtual.enabled) return;
        if (swiper.params.cssMode) (0, _utilsMjs.b)(swiper.wrapperEl, "--swiper-virtual-size", `${swiper.virtualSize}px`);
    });
    Object.assign(swiper.virtual, {
        appendSlide,
        prependSlide,
...
/* eslint-disable consistent-return */ function Keyboard({ swiper, extendParams, on, emit }) {
    ...
    function handle(event) {
        ...
        if (swiper.params.keyboard.onlyInViewport && (isPageUp || isPageDown || isArrowLeft || isArrowRight || isArrowUp || isArrowDown)) {
            ...
            if ((0, _utilsMjs.d)(swiper.el, `.${swiper.params.slideClass}, swiper-slide`).length > 0 && (0, _utilsMjs.d)(swiper.el, `.${swiper.params.slideActiveClass}`).length === 0) return undefined;
            const el = swiper.el;
            const swiperWidth = el.clientWidth;
            const swiperHeight = el.clientHeight;
            const windowWidth = window.innerWidth;
            const windowHeight = window.innerHeight;
            const swiperOffset = (0, _utilsMjs.f)(el);
...
/* eslint-disable consistent-return */ function Mousewheel({ swiper, extendParams, on, emit }) {
    ...
    let timeout;
    let lastScrollTime = (0, _utilsMjs.h)();
    ...
    function animateSlider(newEvent) {
        ...
        return false;
        if (swiper.params.mousewheel.thresholdTime && (0, _utilsMjs.h)() - lastScrollTime < swiper.params.mousewheel.thresholdTime) // Prevent if time between scrolls is below configured threshold
        return false;
        // If the movement is NOT big enough and
        // if the last time the user scrolled was too close to the current one (avoid continuously triggering the slider):
        //   Don't go any further (avoid insignificant scroll movement).
        if (newEvent.delta >= 6 && (0, _utilsMjs.h)() - lastScrollTime < 60) // Return false as a default
        return true;
...
function Scrollbar({ swiper, extendParams, on, emit }) {
    ...
    function setDragPosition(e) {
        ...
        const { el } = scrollbar;
        let positionRatio;
        positionRatio = (getPointerPosition(e) - (0, _utilsMjs.f)(el)[swiper.isHorizontal() ? "left" : "top"] - (dragStartPos !== null ? dragStartPos : dragSize / 2)) / (trackSize - dragSize);
    ...
    function init() {
        ...
        if (el) el.classList[swiper.enabled ? "remove" : "add"](...(0, _utilsMjs.k)(swiper.params.scrollbar.lockClass));
    }
    function destroy() {
        const params = swiper.params.scrollbar;
        const el = swiper.scrollbar.el;
        if (el) el.classList.remove(...(0, _utilsMjs.k)(swiper.isHorizontal() ? params.horizontalClass : params.verticalClass));
        disableDraggable();
    }
    on("changeDirection", ()=>{
    ...
    const enable = ()=>{
        swiper.el.classList.remove(...(0, _utilsMjs.k)(swiper.params.scrollbar.scrollbarDisabledClass));
        if (swiper.scrollbar.el) swiper.scrollbar.el.classList.remove(...(0, _utilsMjs.k)(swiper.params.scrollbar.scrollbarDisabledClass));
        init();
        updateSize();
        setTranslate();
    };
    const disable = ()=>{
        swiper.el.classList.add(...(0, _utilsMjs.k)(swiper.params.scrollbar.scrollbarDisabledClass));
        if (swiper.scrollbar.el) swiper.scrollbar.el.classList.add(...(0, _utilsMjs.k)(swiper.params.scrollbar.scrollbarDisabledClass));
        destroy();
    };
...
function Zoom({ swiper, extendParams, on, emit }) {
    ...
    function onGestureStart(e) {
        ...
        if (!gesture.slideEl) {
            ...
            if (imageEl) gesture.imageWrapEl = (0, _utilsMjs.d)(gesture.imageEl, `.${params.containerClass}`)[0];
    ...
    function onTouchMove(e) {
        ...
        if (!image.isMoved) {
            ...
            image.startX = (0, _utilsMjs.l)(gesture.imageWrapEl, "x") || 0;
            image.startY = (0, _utilsMjs.l)(gesture.imageWrapEl, "y") || 0;
    ...
    function zoomIn(e) {
        ...
        if (e && !(currentScale === 1 && forceZoomRatio)) {
            ...
            offsetX = (0, _utilsMjs.f)(gesture.slideEl).left + window.scrollX;
            offsetY = (0, _utilsMjs.f)(gesture.slideEl).top + window.scrollY;
        ...
        swiper.pagination.bullets.forEach((bulletEl)=>{
            if (swiper.params.pagination.clickable) {
                ...
                if (!swiper.params.pagination.renderBullet) {
                    ...
                    addElLabel(bulletEl, params.paginationBulletMessage.replace(/\{\{index\}\}/, (0, _utilsMjs.j)(bulletEl) + 1));
                }
            }
...
function Thumb({ swiper, extendParams, on }) {
    ...
    function init() {
        ...
        } else if ((0, _utilsMjs.p)(thumbsParams.swiper)) {
    ...
    function update(initial, p) {
        ...
        if (thumbsSwiper.params.loop || isVirtualEnabled()) for(let i = 0; i < thumbsToActivate; i += 1)(0, _utilsMjs.e)(thumbsSwiper.slidesEl, `[data-swiper-slide-index="${swiper.realIndex + i}"]`).forEach((slideEl)=>{
        ...
        if (p?.autoScroll ?? true) autoScroll(initial ? 0 : undefined);
    }
    ...
    function onTouchEnd({ currentPos }) {
        ...
        if (params.freeMode.momentum) {
            if (data.velocities.length > 1) {
                ...
                if (time > 150 || (0, _utilsMjs.h)() - lastMoveEvent.time > 300) swiper.velocity = 0;
...
},{"../shared/utils.mjs":"9mU7V","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7xOD5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function EffectFlip({ swiper, extendParams, on }) {
    ...
    const setTranslate = ()=>{
        ...
        const rotateFix = (0, _utilsMjs.a)(swiper);
        for(let i = 0; i < slides.length; i += 1){
            const slideEl = slides[i];
            let progress = slideEl.progress;
            if (swiper.params.flipEffect.limitRotation) progress = Math.max(Math.min(slideEl.progress, 1), -1);
...
},{"../shared/create-shadow.mjs":"bWkQq","../shared/effect-init.mjs":"88TTi","../shared/effect-target.mjs":"3jkAD","../shared/effect-virtual-transition-end.mjs":"dzFvU","../shared/utils.mjs":"9mU7V","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eFTGe":[function() {},{}],"ae55e":[function() {},{}],"lT27W":[function() {},{}],"4XG2g":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
